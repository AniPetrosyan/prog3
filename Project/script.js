...
function setup() {
    ...
    let kerpar1Count = document.getElementById('kerpar1Count');
    let kerpar2Count = document.getElementById('kerpar2Count');
    let kerpar3Count = document.getElementById('kerpar3Count');
